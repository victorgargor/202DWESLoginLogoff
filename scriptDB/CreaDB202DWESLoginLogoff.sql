CREATE DATABASE IF NOT EXISTS DB202DWESLoginLogoff;
USE  DB202DWESLoginLogoff;

CREATE USER IF NOT EXISTS 'user202DWESLoginLogoff'@'%' IDENTIFIED BY 'paso';
GRANT ALL PRIVILEGES ON DB202DWESLoginLogoffTema5.* TO 'user202DWESLoginLogoff'@'%';
